					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup()
							...
							.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
								.addComponent(panel_1, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 574, Short.MAX_VALUE)
								.addComponent(lblNewLabel, Alignment.LEADING)
								.addComponent(lblInputFile, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE)
								.addGroup(gl_panel.createSequentialGroup()
									.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
										.addComponent(txtbOutputFile, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 471, Short.MAX_VALUE)
										.addComponent(cmbSignerCert, 0, 471, Short.MAX_VALUE))
									.addGap(18)
									.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel.createSequentialGroup()
							.addGap(245)
							.addComponent(btnSign, GroupLayout.DEFAULT_SIZE, 104, Short.MAX_VALUE)
							.addGap(235)))
					.addContainerGap())
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(138)
					.addComponent(progressSignature, GroupLayout.DEFAULT_SIZE, 318, Short.MAX_VALUE)
					.addGap(138))
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(200)
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(btnCertDetails, GroupLayout.PREFERRED_SIZE, 28, GroupLayout.PREFERRED_SIZE))
					.addGap(29)
